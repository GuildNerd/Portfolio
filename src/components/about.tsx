export default function About() {
    return (
        <div className="text-white flex flex-col items-center gap-2" id="about">
            ...
            <div className="flex flex-col items-center gap-2 p-4 mt-4 bg-slate-700">
                ...
                <p className="text-justify lg:px-8">
                    ...
                    que absorvi com a minha experiência prévia de mercado. Considero o usuário como ponto central do desenvolvimento, por isso, gosto de acompanhar e contribuir durante todo ciclo de vida de desenvolvimento do software, da ideação à manutenção, tendo sempre a experiência do usuário como norte.
                </p>
            </div>
        </div>
    )
